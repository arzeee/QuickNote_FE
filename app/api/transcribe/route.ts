...
export const dynamic = "force-dynamic"; // supaya streaming & file besar bisa jalan
...
export async function POST(req: Request) {
  try {
    ...
    // jalankan whisper-cli (local binary)
    const whisperPath =
 ...
 await new Promise<void>((resolve, reject) => {
  whisperProc.on("close", (code) =>
    ...
    try {
      ...
      transcript = "Transkrip tidak ditemukan.";
    }
